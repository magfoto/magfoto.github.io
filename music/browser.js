...
const ARTISTS = [];
const RELEASES = [{cover:'cover_160.jpg?nIedPWj-u9o',title:'New Chapter',tracks:[{number:'1.',title:'0000A',url:'un-nouveau-chapitre/1/'},{number:'2.',title:'ETERNA1_',url:'un-nouveau-chapitre/2/'},{number:'3.',title:'OP-Z-PASSERS',url:'un-nouveau-chapitre/3/'},{number:'4.',title:'Organisme',url:'un-nouveau-chapitre/4/'}],url:'un-nouveau-chapitre/'},{cover:'cover_160.jpg?E1lmUAPsnUU',title:'CODI Journal',tracks:[{number:'1.',title:'Jupiter Sine Generator',url:'codi-journal/1/'},{number:'2.',title:'Melted Lick',url:'codi-journal/2/'}],url:'codi-journal/'},{cover:'cover_160.jpg?QPFePPovqxU',title:'Last Metropolis Serenade',tracks:[{number:'1.',title:'The Last Metropolis (Post-Lighthouse Serenade)',url:'the-last-metropolis-serenade/1/'}],url:'the-last-metropolis-serenade/'},{cover:'cover_160.jpg?JJsq89ZM06E',title:'Ambient Assembly',tracks:[{number:'1.',title:'Ambient Assembly',url:'ambient-assembly/1/'}],url:'ambient-assembly/'}];
